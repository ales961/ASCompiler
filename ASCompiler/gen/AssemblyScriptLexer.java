...
public class AssemblyScriptLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"VAR", "LET", "CONST", "FUNCTION", "EXPORT", "RETURN", "IF", "ELSE", 
	...
	public AssemblyScriptLexer(CharStream input) {
		super(input);
